...
ScheduleCreationPopup.prototype._onClickSaveSchedule = function(target) {
    ...
    var place = document.querySelector("input[name='meetingPlace']:checked") ? document.querySelector("input[name='meetingPlace']:checked").value : 0;
    
    var etc = [userName.value, place];
...
ScheduleCreationPopup.prototype._makeEditModeData = function(viewModel) {
    ...
    var title, userName, place, isPrivate, location, startDate, endDate, isAllDay, state, place_1_checked, place_2_checked;
...
ScheduleCreationPopup.prototype._onClickUpdateSchedule = function(form) {
    var changes = common.getScheduleChanges(
        this._schedule,
        ['calendarId', 'title', 'userName', 'place', 'location', 'start', 'end', 'isAllDay', 'state'],
        {
