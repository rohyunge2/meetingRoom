...
var helpers = {
    ...
    'time-scheduleBlock': function(viewModel) {
        ...
        if ( viewModel.model.place == 2 ){
            left = getElSize(50, '%', 'left');
            width = getElSize(50, '%', 'width');
            pl = getElSize(2, "px", "padding-left");
        } else {
            left = getElSize(0, '%', 'left');
            width = getElSize(50, '%', 'width');
            pl = getElSize(0, "px", "padding-left");
        }

        return [top, left, width, height, pl].join(';');
    },
    ...
    'alldayTitle-tmpl': function() {
        ...
        return '<span class="' + className + '">장소</span>';
